...
def noise():
    print dump(*e.eg9(noise=12.5, dr=0.02, pts=256))
    print dump(*e.eg9(noise=2.5 , dr=0.02, pts=256))
    print dump(*e.eg9(noise=.5  , dr=0.02, pts=256))
    print dump(*e.eg9(noise=.1  , dr=0.02, pts=256))


def linearity():
    f1 = ftime.csComplex(1, 0.3, 0, 0.005)
...
def transients():
    print dump(*e.eg21(transients=1,     noise=50, pts=256))
    print dump(*e.eg21(transients=10,    noise=50, pts=256))
    print dump(*e.eg21(transients=100,   noise=50, pts=256))
    print dump(*e.eg21(transients=1000,  noise=50, pts=256))
    print dump(*e.eg21(transients=10000, noise=50, pts=256))
...
#    e.eg14([], [(1, 4, 0.005), (1, 3.9, 0.005)], 8192)
    print dump(*e.eg14([], [(10, 4, 0.02), (10, 3.9, 0.02)], 32))
    print dump(*e.eg14([], [(10, 4, 0.02), (10, 3.9, 0.02)], 128))
    print dump(*e.eg14([], [(10, 4, 0.02), (10, 3.9, 0.02)], 512))
